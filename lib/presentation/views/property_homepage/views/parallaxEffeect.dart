...
//   @override
//   State<ParallaxPropertyCardBig> createState() => _ParallaxPropertyCardBigState();
// }
...
//                 children: [
//                   Text(widget.title, style: AppTextStyles.h18semi.copyWith(color: Colors.white)),
//                   SizedBox(height: 4.h),
//                   Text(widget.location, style: AppTextStyles.h14bold.copyWith(color: Colors.white70)),
//                   SizedBox(height: 4.h),
//                   Text("\$${widget.price.toStringAsFixed(0)}", style: AppTextStyles.h16bold.copyWith(color: Colors.white)),
//                 ],
//               ),
//             ),
//           ),
